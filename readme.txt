...
1) Click on 'Create Link' in the WP Dynamic Links section of WordPress admin panel.
...
**After that, you can use the WP Dynamic Links-powered link everywhere you would have used the original URL.**

WP Dynamic Links will track clicks on your links, providing a detailed summary and information on individual clicks like browser type, IP address, country code, and referring URL.
...
Either: -
	...
	* Unzip wp-dynamic-links.zip and upload the contents to /wp-content/plugins/, and then activate the plugin from the Plugins page in WordPress
