...
CREATE TABLE {$table_prefix}links (
	...
	redirect_type ENUM('301','302','307','META_REFRESH','JAVASCRIPT') NOT NULL DEFAULT '301',
...
CREATE TABLE {$table_prefix}rules (
	id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
	link_id BIGINT(20) UNSIGNED NOT NULL,
	type ENUM('ONE_SET','BY_COUNTRY','BY_RULE','EXPIRED') NOT NULL DEFAULT 'ONE_SET',
...
CREATE TABLE {$table_prefix}stats (
	...
	rule_type ENUM('ONE_SET','BY_COUNTRY','BY_RULE','EXPIRED') NOT NULL DEFAULT 'ONE_SET',
